...
;(function () {
        ...
        ;[].forEach.call(document.querySelectorAll('script'), function (script) {
            ...
            if (script.type === 'systemjs-module') {
                ...
                var fetchPromise = script.src
                    ? (System.fetch || fetch)(script.src, { integrity: script.integrity, passThrough: true })
                          .then(function (res) {
    ...
    if (false) systemJSPrototype.fetch = fetch
